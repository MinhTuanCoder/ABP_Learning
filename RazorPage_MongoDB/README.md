...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p cf974fca-d83c-4221-9263-c4eb6d6e0743
```

> `cf974fca-d83c-4221-9263-c4eb6d6e0743` is the password of the certificate, you can change it to any password you want.
