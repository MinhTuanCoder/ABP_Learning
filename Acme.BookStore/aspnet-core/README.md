...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 23ce5ced-0f9b-42c4-816f-c8fbd58d82bb
```

> `23ce5ced-0f9b-42c4-816f-c8fbd58d82bb` is the password of the certificate, you can change it to any password you want.
